...
that was the best model to this project, but you could run the other models that are on commented lines
...
4. "DB_Valor_Prima_Anual_Cleaned.csv": it is an output of the "1.T_Aseguradora_Preprocessing.ipynb"

5. "DB_Valor_Prima_Anual_Cleaned_antiguedadCol.csv": it is an output of the preprocessing, and it is used in T_Models_Aseguradora.ipynb to add some 
